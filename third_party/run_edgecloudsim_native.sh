#!/bin/bash
cd /proj/oasees-PG0/NS3-Edge/NSEdge-Validation/third_party/EdgeCloudSim/scripts/sample_app1
...
echo "{\"EdgeCloudSim_Native_Delay\": $DELAY}" > /proj/oasees-PG0/NS3-Edge/NSEdge-Validation/third_party/ecs_native_metrics.json
