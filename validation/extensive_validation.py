...
def main() -> None:
    ...
    clear_shaping()
    net_results["sim"]["loss"] = run_simulated(12.0, 5.0, 150, 4, "760Mbps", 0.03, 0.0, calibrated_base_latency, "results/net_sim_loss.csv")
    ...
    clear_shaping()
    net_results["sim"]["jitter"] = run_simulated(12.0, 5.0, 150, 4, "760Mbps", 0.0, 5000.0, calibrated_base_latency, "results/net_sim_jitter.csv")
